...
public class SaveFileInTextEditorOnMouseClickSystem extends EntitySystem {
    ...
    public SaveFileInTextEditorOnMouseClickSystem() {
    ...
    public void addedToEngine(Engine engine) {
        ...
        this.entities = engine.getEntitiesFor(
            Family.all(SaveFileOnMouseClickComponent.class, MouseClickEventComponent.class).get()
        );
    }
    ...
    public void update(float delta) {
        ...
        for(Entity entity : entities) {
            ...
            if(file.isDirectory() == false) {
                file.writeString(textEditText.text, false);
                select.startIndex = -1;
                select.endIndex = -1;
