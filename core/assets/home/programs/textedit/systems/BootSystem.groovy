...
public class BootSystem extends EntitySystem {
    ...
    public void addedToEngine(Engine engine) {
        ...
        html.html = Gdx.files.local("home/programs/textedit/assets/index.html").readString();

        CSSComponent css = new CSSComponent();
        css.css =  Gdx.files.local("home/programs/textedit/assets/styles.css").readString();
