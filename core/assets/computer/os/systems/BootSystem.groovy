...
public class BootSystem extends EntitySystem {	
    ...
    public void addedToEngine(Engine engine) {
        ...
        registerTexture.fileName = "computer/os/assets/badlogic.jpg";
        ...
        registerAtlas.fileName = "computer/os/assets/userosgui/userosgui.atlas";
        ...
        registerPizzaAtlas.fileName = "computer/os/assets/pizza/pizza.atlas";
        ...
        textEntity.add(new RegisterBitmapFontAssetComponent(fileName: "computer/os/assets/userosgui/Lucida Console.fnt"));
        textEntity.add(new GetBitmapFontAssetComponent(fileName: "computer/os/assets/userosgui/Lucida Console.fnt"));
        ...
        background.add(new RegisterTextureAssetComponent(fileName: "computer/os/assets/background.jpg"));
        background.add(new GetTextureAssetComponent(fileName: "computer/os/assets/background.jpg"));
